package top.keiskeiframework.cpreading.reader.sdk;
...
public class WXPay {
    ...
    public WXPay(final WXPayConfig config) throws Exception {
        this(config, null, true, false, WXPayConstants.SignType.MD5);
    }

    public WXPay(final WXPayConfig config, final boolean autoReport) throws Exception {
        this(config, null, autoReport, false, WXPayConstants.SignType.MD5);
    }


    public WXPay(final WXPayConfig config, final boolean autoReport, final boolean useSandbox) throws Exception {
        this(config, null, autoReport, useSandbox, WXPayConstants.SignType.MD5);
    }

    public WXPay(final WXPayConfig config, final String notifyUrl) throws Exception {
        this(config, notifyUrl, true, false, WXPayConstants.SignType.MD5);
    }

    public WXPay(final WXPayConfig config, final String notifyUrl, final boolean autoReport) throws Exception {
        this(config, notifyUrl, autoReport, false, WXPayConstants.SignType.MD5);
    }

    public WXPay(final WXPayConfig config, final String notifyUrl, final boolean autoReport, WXPayConstants.SignType signType) throws Exception {
        this(config, notifyUrl, autoReport, false, signType);
    }

    public WXPay(final WXPayConfig config, final String notifyUrl, final boolean autoReport, final boolean useSandbox, WXPayConstants.SignType signType) throws Exception {
        this.config = config;
    ...
    public String getSandboxSignKey() {
        try {
            ...
            String strXML = this.requestWithoutCert("/sandboxnew/pay/getsignkey", params, 3000, 3000);
    ...
    public String requestWithoutCert(String urlSuffix, Map<String, String> reqData,
        ...
        log.info("微信支付请求数据xml:\n{}", reqBody);
        String resp = this.wxPayRequest.requestWithoutCert(urlSuffix, msgUUID, reqBody, connectTimeoutMs, readTimeoutMs, autoReport);
        log.info("微信支付返回数据xml:\n{}", resp);
        return resp;
    }
