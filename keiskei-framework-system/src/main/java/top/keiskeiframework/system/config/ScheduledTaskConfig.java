...
public class ScheduledTaskConfig implements SchedulingConfigurer {
    ...
    public void configureTasks(@NonNull ScheduledTaskRegistrar taskRegistrar) {
        for (ScheduledTask scheduledTask : scheduledTaskService.findList()) {
            ...
            taskRegistrar.addTriggerTask(task,
                    triggerContext -> new CronTrigger(scheduledTaskService.findOneById(scheduledTask.getId()).getCron()).nextExecutionTime(triggerContext)
            );
        }
    }
